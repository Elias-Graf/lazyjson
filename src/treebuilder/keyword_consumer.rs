...
mod tests {
    ...
    #[test]
    pub fn non_keyword() {
        let r = keyword_consumer(&[Token::str("non token")], 0).unwrap();
    ...
    pub fn consume_false() {
        let r = keyword_consumer(&[Token::kwd("false")], 0).unwrap();
    ...
    #[test]
    pub fn consume_null() {
        let r = keyword_consumer(&[Token::kwd("null")], 0).unwrap();
    ...
    #[test]
    pub fn consume_true() {
        let r = keyword_consumer(&[Token::kwd("true")], 0).unwrap();
    ...
    #[test]
    pub fn at_offset() {
        let inp = &[Token::str("placeholder"), Token::kwd("null")];
    ...
    pub fn unknown_keyword() {
        let misspelled_true = Token::kwd("tru");
